...
// MP 3 ------------------------------------------------------------------------
  ...
  CODE_EDITOR_STYLE_MIDLET_BG = $FFFFFF; // White
  CODE_EDITOR_STYLE_MIDLET_FG = $000000; // Black
  CODE_EDITOR_STYLE_MIDLET_SELECTED_BG = $808080; // Gray
  CODE_EDITOR_STYLE_MIDLET_SELECTED_FG = $000000; // Black
  CODE_EDITOR_STYLE_MIDLET_COMMENT_BG = $FFFFFF; // White
  CODE_EDITOR_STYLE_MIDLET_COMMENT_FG = $008000; // Green
  CODE_EDITOR_STYLE_MIDLET_SYMBOL_BG = $FFFFFF; // White
  CODE_EDITOR_STYLE_MIDLET_SYMBOL_FG = $000000; // Black
  CODE_EDITOR_STYLE_MIDLET_KEYWORD_BG = $FFFFFF; // White
  CODE_EDITOR_STYLE_MIDLET_KEYWORD_FG = $FF0000; // Blue
  CODE_EDITOR_STYLE_MIDLET_DIRECTIVE_BG = $FFFFFF; // White
  CODE_EDITOR_STYLE_MIDLET_DIRECTIVE_FG = $008000; // Green
  ...
  CODE_EDITOR_STYLE_CLASSIC_BG = $800000; // Navy
  CODE_EDITOR_STYLE_CLASSIC_FG = $00FFFF; // Yellow
  CODE_EDITOR_STYLE_CLASSIC_SELECTED_BG = $C0C0C0; // Silver
  CODE_EDITOR_STYLE_CLASSIC_SELECTED_FG = $800000; // Navy
  CODE_EDITOR_STYLE_CLASSIC_COMMENT_BG = $800000; // Navy
  CODE_EDITOR_STYLE_CLASSIC_COMMENT_FG = $C0C0C0; // Silver
  CODE_EDITOR_STYLE_CLASSIC_SYMBOL_BG = $800000; // Navy
  CODE_EDITOR_STYLE_CLASSIC_SYMBOL_FG = $C0DCC0; // MoneyGreen
  CODE_EDITOR_STYLE_CLASSIC_KEYWORD_BG = $800000; // Navy
  CODE_EDITOR_STYLE_CLASSIC_KEYWORD_FG = $FFFFFF; // White
  CODE_EDITOR_STYLE_CLASSIC_DIRECTIVE_BG = $808080; // Gray
  CODE_EDITOR_STYLE_CLASSIC_DIRECTIVE_FG = $FFFFFF; // White
  ...
  MPDEFINES = DEFINE_J2ME + COMMA + DEFINE_MPC + COMMA + DEFINE_MP30;
