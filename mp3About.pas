...
type
  ...
  private
    ...
    FOtherLabel: TLabel;
    FHtmlDisplay: TtuiHtmlScrollBox;
...
begin
  FHtmlDisplay := TtuiHtmlScrollBox.Create(Self);
  FHtmlDisplay.Parent := pnlAbout;
  FHtmlDisplay.SetBounds(66, 200, 512, 208);
  FHtmlDisplay.BorderStyle := bsNone;
  FHtmlDisplay.Color := $20D0FE;
  FHtmlDisplay.OnClick := imgAboutClick;
...
begin
  ...
  FHtmlDisplay.RenderHTML(
    '<br>'+
    '<p bgcolor="#FED020" align="center"><font name="Tahoma" color="#444444" size="9">'+
    '<br>'+
    '<b>MIDletPascal compiler</b> [license: GPL]<br>'+
    '</font><font name="Tahoma" color="#555555" size="8">'+
