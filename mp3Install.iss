...
AppName=MIDletPascal 3.5 FINAL
AppVerName=MIDletPascal 3.5 FINAL
DefaultDirName={pf}\MIDletPascal 3.5 FINAL
DefaultGroupName=MIDletPascal 3.5 FINAL
...
Source: bin\CHANGES.txt; DestDir: {app}
...
[Icons]
Name: {group}\MIDletPascal 3.5 FINAL; Filename: {app}\mp3IDE.exe; WorkingDir: {app}; IconFilename: {app}\mp3IDE.exe; IconIndex: 0
Name: {group}\MIDletPascal 3.5 FINAL Demos; Filename: {commondocs}\MIDletPascal\Demos\
Name: {group}\MIDletPascal 3.5 FINAL Help; Filename: {app}\Help\en\Index.htm
Name: {group}\MIDletPascal 3.5 FINAL Readme; Filename: {app}\README.txt
Name: {group}\MIDletPascal 3.5 FINAL Changes; Filename: {app}\CHANGES.txt
Name: {group}\MIDletPascal 3.5 FINAL History; Filename: {app}\HISTORY.txt
Name: {group}\MIDletPascal 3.5 FINAL License; Filename: {app}\LICENSE.txt
